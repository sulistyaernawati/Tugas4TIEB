        ...
        <div class="card">
            <div class="body">
                <div class="card-body">
                    <div class="row clearfix">
                    <div class="col-xs-12">
                            <h3 class="card-inside-title">Buku Besar</h3>
                        ...
                        <br>
                            ...
                            <a target="_blank" href='modules/cetak_bukubesar.php?awal=<?= $_POST['awal']; ?>&akhir=<?= $_POST['akhir']; ?>'>
                            ...
                            <a target="_blank" href='modules/cetak_bukubesar_all.php' style="position:relative; left:150px;">
                            <button class="btn btn-white btn-primary btn-bold">
