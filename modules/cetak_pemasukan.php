 ...
 include "../config/koneksi.php";
  ...
  $query	= mysqli_query($conn,"SELECT A.*, B.nama_siswa AS siswa, C.nama_program AS program, D.nama_kelas AS kelas FROM pemasukan AS A 
  LEFT JOIN siswa AS B ON(A.id_siswa = B.id_siswa)
  LEFT JOIN program AS C ON(A.id_program = C.id_program)
  LEFT JOIN kelas AS D ON(A.id_kelas = D.id_kelas) where A.id_pemasukan = '$id'");
                ...
                <td colspan="2">
                    <table>
                        <tr>
                            ...
                            <td>
                                Invoice #: <?php echo $hasil['id_pemasukan'];?><br>
